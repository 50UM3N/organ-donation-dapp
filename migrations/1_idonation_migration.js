...
module.exports = async function (deployer, network, accounts) {
    const toByte32 = (data) => {
        return contract.constructor.web3.utils.padRight(contract.constructor.web3.utils.asciiToHex(data), 64);
    };
    const toString = (byte) => {
        try {
            return contract.constructor.web3.utils.toUtf8(byte);
        } catch (e) {
            return contract.constructor.web3.utils.toAscii(byte);
        }
    };
