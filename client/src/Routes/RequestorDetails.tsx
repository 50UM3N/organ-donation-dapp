...
const RequestorDetails: React.FC<props> = ({ contract }) => {
    ...
    useEffect(() => {
        (async () => {
            ...
            try {
                const requestors = await contract?.methods.getRequestorById(requestorId).call({ from: accounts[0] });
...
export default connect(mapStateToProps, mapDispatchToProps)(RequestorDetails);
